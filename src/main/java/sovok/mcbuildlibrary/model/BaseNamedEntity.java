// file: src/main/java/sovok/mcbuildlibrary/model/BaseNamedEntity.java
...
@Setter
@ToString
@NoArgsConstructor(access = AccessLevel.PROTECTED) // Keep protected no-arg constructor for JPA on potential direct use/subclassing
...
public abstract class BaseNamedEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BaseNamedEntity that)) return false;
